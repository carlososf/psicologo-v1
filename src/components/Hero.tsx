        ...
        <div className="relative hidden lg:block">
          ...
          >
            <div
              ...
              style={{
                background: "linear-gradient(135deg, #e4ede4 0%, #c9dbc9 40%, #f7f0e6 100%)",
            ...
            >
              ...
              <svg width="280" height="280" viewBox="0 0 280 280" fill="none" xmlns="http://www.w3.org/2000/svg">
                {/* Sofa / Chair */}
                <rect x="60" y="160" width="160" height="70" rx="16" fill="#527d52" opacity="0.3"/>
                <rect x="40" y="140" width="40" height="90" rx="12" fill="#527d52" opacity="0.4"/>
                <rect x="200" y="140" width="40" height="90" rx="12" fill="#527d52" opacity="0.4"/>
                <rect x="60" y="148" width="160" height="50" rx="12" fill="#527d52" opacity="0.5"/>
                {/* Person silhouette */}
                <circle cx="140" cy="100" r="32" fill="#1a2744" opacity="0.15"/>
                <ellipse cx="140" cy="155" rx="28" ry="20" fill="#1a2744" opacity="0.12"/>
                {/* Plant */}
                <rect x="218" y="190" width="8" height="40" rx="4" fill="#3f6340" opacity="0.5"/>
                <ellipse cx="222" cy="185" rx="18" ry="22" fill="#527d52" opacity="0.5"/>
                <ellipse cx="208" cy="195" rx="12" ry="16" fill="#527d52" opacity="0.4"/>
                <ellipse cx="235" cy="192" rx="12" ry="14" fill="#527d52" opacity="0.4"/>
                {/* Window light */}
                <rect x="80" y="40" width="50" height="70" rx="8" fill="#efe0cc" opacity="0.6"/>
                <line x1="105" y1="40" x2="105" y2="110" stroke="#d0a87a" strokeWidth="2" opacity="0.4"/>
                <line x1="80" y1="75" x2="130" y2="75" stroke="#d0a87a" strokeWidth="2" opacity="0.4"/>
                {/* Warm dots */}
                <circle cx="170" cy="60" r="6" fill="#d0a87a" opacity="0.4"/>
                <circle cx="190" cy="80" r="4" fill="#d0a87a" opacity="0.3"/>
                <circle cx="160" cy="90" r="3" fill="#a3c1a3" opacity="0.5"/>
              </svg>
            </div>
          </div>
